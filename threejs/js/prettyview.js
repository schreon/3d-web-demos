...
PhysicsView.create = function(field_width, field_height){
  ...
  self.camera = new THREE.OrthographicCamera(-w, w, -h, h, -100, 10000 );
  ...
  var pointLight =
    new THREE.PointLight(0xFFFFFF, 0.8);
  ...
  // plane
  var plane = new THREE.Mesh(new THREE.PlaneGeometry(field_width, field_height, 32, 32), new THREE.MeshPhongMaterial({
      color: 0x222222,
      ambient: 0x222222
  }));
  //plane.overdraw = true;
